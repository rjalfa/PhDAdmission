...
{
	private AdapterTextField nameField;
	private AdapterTextField emailField;
	private AdapterTextField enrollField;
	private AdapterChoiceBox<String> categoryField;
	private AdapterToggleGroup genderField;
	private AdapterToggleGroup phyDisField;
	private AdapterToggleGroup dateOfBirthConditionField;
	private AdapterDatePicker dateOfBirthField;
	private AdapterChoiceBox<String> phdStreamField;
	private AdapterChoiceBox<String> graduationDegreeField;
	private AdapterChoiceBox<String> pgDegreeField;
	private AdapterChoiceBox<String> xBoardField;
	private AdapterChoiceBox<String> xiiBoardField;
	private AdapterChoiceBox<String> gradDeptField;
	private AdapterChoiceBox<String> pgDeptField;
	private AdapterTextField gradUnivField;
	private AdapterTextField pgUnivField;
	private AdapterChoiceBox<String> gradStateField;
	private AdapterChoiceBox<String> pgStateField;
	private AdapterCheckBox xMarksFieldGreater;
	private AdapterCheckBox xMarksFieldEqual;
	private AdapterCheckBox xMarksFieldLesser;
	private AdapterTextField xMarksField;
	private AdapterCheckBox xiiMarksFieldGreater;
	private AdapterCheckBox xiiMarksFieldEqual;
	private AdapterCheckBox xiiMarksFieldLesser;
	private AdapterTextField xiiMarksField;
	private AdapterCheckBox gradMarksFieldGreater;
	private AdapterCheckBox gradMarksFieldEqual;
	private AdapterCheckBox gradMarksFieldLesser;
	private AdapterTextField gradMarksField;
	private AdapterCheckBox pgMarksFieldGreater;
	private AdapterCheckBox pgMarksFieldEqual;
	private AdapterCheckBox pgMarksFieldLesser;
	private AdapterTextField pgMarksField;
	private AdapterCheckBox gateMarksFieldGreater;
	private AdapterCheckBox gateMarksFieldEqual;
	private AdapterCheckBox gateMarksFieldLesser;
	private AdapterTextField gateMarksField;
	private AdapterDatePicker datedFromField;
	private AdapterDatePicker datedToField;
	private AdapterButton submitButton;
